...
heroImage.src = "images/poper.png";
...
BulletReady.src = "images/monster.png";
...
var update = function (modifier) {
	...
	if (37 in keysDown && hero.x >= 20) { // Player holding left
		...
		heroImage.src = "images/poper_left.png";
	}
	if (39 in keysDown && hero.x <= 540) { // Player holding right
		hero.x += hero.speed * modifier;
		heroImage.src = "images/poper_right.png";
	}
